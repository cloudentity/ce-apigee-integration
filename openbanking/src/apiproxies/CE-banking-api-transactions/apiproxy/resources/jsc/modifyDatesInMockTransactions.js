 ...
 */
 ...
 if (txList && txList.length > 0) {
    for (var i = 0; i < txList.length; i++) {
        curTx = txList[i];
        // print("Working on tx # " + i + " - PostingDateTime = " + curTx.postingDateTime + " - ValueDateTime = " + curTx.valueDateTime + "- postingDateTime = " + curTx.postingDateTime);
        ...
        curTx.executionDateTime = modifyDateIfWithinRange(curTx.executionDateTime);
        // print("Now postingDateTime = " + curTx.postingDateTime);
        txList[i] = curTx;
